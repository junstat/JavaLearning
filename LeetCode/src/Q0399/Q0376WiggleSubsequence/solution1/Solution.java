package Q0399.Q0376WiggleSubsequence.solution1;
...
/*
    ...
    If nums[i] == nums[i-1], that means it will not change anything becasue it didn't wiggle at all. so both down[i]
    and up[i] keep the same.
