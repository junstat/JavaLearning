...
class Solution {
    ...
    public int minimumEffortPath(int[][] heights) {
        ...
        while (!minHeap.isEmpty()) {
            ...
            if (d > dist[r][c]) // this is an outdated version
                continue; // skip it
            if (r == m - 1 && c == n - 1) // Reach to bottom right
                return d;
            for (int i = 0; i < 4; i++) {
        ...
        return 0; // Unreachable code, Java require to return
    }
}
