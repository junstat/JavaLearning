package com.jun.chap11_api.section03.jdk8;
...
public class DateTimeTest {
   ...
   */
    ...
    @Test
    public void test2() {
        // 偏移性: Date中的年份是从1900开始的，而且月份都从0开始
    ...
    public void test3() {
        ...
        System.out.println(localDate); // 2023-12-27
        System.out.println(localTime); // 15:39:52.716
        System.out.println(localDateTime); // 2023-12-27T15:39:52.716

        // of(): 获取指定的日期、时间对应的实例
        LocalDate localDate1 = LocalDate.of(2022, 12, 27);
        LocalDateTime localDateTime1 = LocalDateTime.of(2022, 12, 27, 23, 45);
    ...
    public void test5() {
        ...
        System.out.println(strDateTime);  // 2023-12-27 15:44:45

        // 解析: 字符串 -> 日期、时间
        TemporalAccessor temporalAccessor = dateTimeFormatter.parse("2023-12-25 14:22:23");
